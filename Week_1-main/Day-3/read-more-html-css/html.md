...
[https://github.com/sei-ec-remote/html_top_ten_movies_table](https://github.com/sei-ec-remote/html_top_ten_movies_table)
...
* **Method** - The HTTP Verb that this form will be using \(HTML only knows GET and POST, but there are ways to override this default which we will see when we use Node and React. The default method is GET so if you are making a GET request you can leave this empty. 
...
[https://github.com/sei-ec-remote/html\_user\_inputs](https://github.com/sei-ec-remote/html_user_inputs)
